...
flight_schema = {
    ...
    'eft': {'type': 'integer', 'required': True},       # esmimate flight time
    'price': {'type': 'number', 'required': True},      # number -  type float
    'ac': {'type': 'string', 'required': True, 'allowed': get_ac()},    # 'allowed' - список разреженных самолетов
}
...
ticket_schema = {
    ...
    'from': {'type': 'string', 'required': True, 'allowed': get_flight_from()},
    'to': {'type': 'string', 'required': True, 'allowed': get_flight_to()},
    'boarding_time': {'type': 'datetime', 'required': True},
    'arrival_time': {'type': 'datetime', 'required': True},
    'price': {'type': 'number', 'required': True, 'allowed': get_price()},
    'ac': {'type': 'string', 'required': True, 'allowed': get_ac()},
