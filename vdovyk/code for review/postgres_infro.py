...
class Students(Base):
    ...
    group_id = Column(Integer, ForeignKey("groups.group_id"), nullable=False, on_delete="SET NULL")
...
class Lectures(Base):
    ...
    audience_id = Column(Integer, ForeignKey("audiences.audience_id"), nullable=False, on_delete="SET NULL")
    group_id = Column(Integer, ForeignKey("groups.group_id"), nullable=False, on_delete="SET NULL")
    teacher_id = Column(Integer, ForeignKey("teachers.teacher_id"), nullable=False, on_delete="SET NULL")
